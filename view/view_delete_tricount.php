...
<body>
    ...
    <div class="main">
        <table class="confirm_delete">
            ...
            <tr>
                <td class="empty">
                    <p class="text_confirm">Do you really want to delete tricount <b>"<?= strlen($tricount->title) > 25 ? substr($tricount->title, 0, 25)."..." : $tricount->title ?>"</b> and all of his dependencies ? <br> This process can't be undone.</p>
